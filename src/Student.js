...
const Student=()=> {
    ...
    React.useEffect(() => {
        if (!load) {
            axios.get('https://62c5391ba361f725127d8eed.mockapi.io/students').then(res => setProduct(res.data));
        }
        setLoad(true);
    })
    ...
    const handleSubmit = (formData,{resetForm}) => {
        if (formData.id !== undefined && formData.id !== '') {
            axios.put(`https://62c5391ba361f725127d8eed.mockapi.io/students/${formData.id}`,
                {
                    name: formData.name,
                    age: formData.age,
            ...
            console.log("post");
            axios.post(`https://62c5391ba361f725127d8eed.mockapi.io/students`,
                {
                    name: formData.name,
                    age: formData.age,
                    school: formData.school,
    ...
    const handleDelete = (id) => {
        axios.delete(`https://62c5391ba361f725127d8eed.mockapi.io/students/${id}`);
